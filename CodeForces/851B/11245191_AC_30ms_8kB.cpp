...
{
	/*
	long double k1 = (node[1].y-node[0].y)/(node[1].x-node[0].x);
	long double k2 = (node[2].y-node[0].y)/(node[2].x-node[0].x);
	*/
	double k1 = (node[1].x-node[0].x)*(node[2].y-node[0].y);
	double k2 = (node[1].y-node[0].y)*(node[2].x-node[0].x);
	double tmp1 = pow((node[1].y-node[0].y),2);
	double tmp2 = pow((node[1].x-node[0].x),2);
	tmp1 = tmp1+tmp2;
